...
(check-equal?
 (kaz-tagger-deterministic "Жобаны 5 кезеңге бөліп, 12 жылда жүзеге асыру жоспарланып отыр.")
 "^Жобаны/жоба<n><acc>$ ^5/5<num>/5<num><ord>$ ^кезеңге/кезең<n><dat>$ ^бөліп/бөл<v><tv><gna_perf>$^,/,<cm>$ ^12/12<num>/12<num><ord>$ ^жылда/жыл<n><loc>$ ^жүзеге/жүзе<n><dat>$ ^асыру/асыр<v><tv><ger><nom>$ ^жоспарланып/жоспарла<v><tv><pass><prc_perf>$ ^отыр/отыр<vaux><pres><p3><sg>$^./.<sent>$")
